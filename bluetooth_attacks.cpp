...
// ── NRF24 hardware (BLE Jammer) ──────────────────────────────────────────
// BLE Jammer needs the physical NRF24L01+ radio to emit a 2.4GHz carrier.
// The shared radio object + SPI bus arbitration live in nrf24_config.cpp
// (also used by the 2.4GHz attack suite) so both features stay in sync.
